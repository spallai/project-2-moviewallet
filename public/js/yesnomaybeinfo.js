var movie = require("./api_calls.js");
...
const genMovie = () => {
    ...
    movie(function (result) {
        ...
        $(".trailer-box").attr("src", result.Trailer + "autoplay=1");
    });
}
...
$("#yes").on("click", function () {
    ...
    $.ajax("/api/movies", {
        ...
        function () {
            console.log("we done postin' now!");
...
$("#info").on("click", function () {
    ...
    $("#imdb-link").attr("href", "" + + "/");
    $("#imdb-link").html("<p>Imdb Link: <a href='https://www.imdb.com/title/'" + $(".trailer-box").attr("imdbId") + "'/'>https://www.imdb.com/title/" + $(".trailer-box").attr("imdbId") + "/</a></h1></p>");
